...
export const QUESTIONS: Question[] = [
  ...
  // ── Communication · Persuade ───────────────────────────────────────────────
  {
    ...
    strengthOrder: 3,
    skillset: 'Persuade',
    objective: 'Do you frame your thinking and adapt your style so your ideas land with different people?',
  ...
  // ── Critical Thinking · Solve ──────────────────────────────────────────────
  {
    ...
    strengthOrder: 4,
    skillset: 'Solve',
    objective: 'Do you diagnose root causes, identify blockers, and seek better solutions?',
